#' giosDownloader: package for exploring air pollution data in Poland.
#'
#' Package provides functions that help import datasets from .xlsx files provided on GIOŚ website, 
#' convert them to the form suitable for analyses and calculate maxima over given period.
#' 
